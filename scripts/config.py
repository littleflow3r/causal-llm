...
class Config(object):
    ...
    def __get_config(self):
        ...
        parser.add_argument('--lckg_dir',
                            type=str,
                            #default='./resource/lckg/semlcgent_ckv_q3.txt',
                            default='./lckg_dir',
                            help='location of LCKG')

        parser.add_argument('--freeze_lckg',
                            type=bool,
                            default=False,
                            help='freeze the embedding or fine tuned')

...
class Tokenizer(object):
    ...
    def build_vocab(self):
        vocab = set()
        filelist = ['train_new', 'dev_new', 'test_new']
...
class MyCorpus(object):
    ...
    def load_corpus(self, filetype):
        ...
        """
        if filetype in ['train_new', 'dev_new', 'test_new']:
...
class MyDataLoader(object):
    ...
    def get_train(self):
        ret = self.__get_data(filetype='train_new', shuffle=True)
        print('finish loading train!')
        return ret

    def get_dev(self):
        try:
            ret = self.__get_data(filetype='dev_new', shuffle=False)
            print('finish loading dev!')
        except:
            ret = self.__get_data(filetype='test_new', shuffle=False)
